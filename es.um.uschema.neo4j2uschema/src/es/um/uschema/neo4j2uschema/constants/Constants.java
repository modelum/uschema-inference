package es.um.uschema.neo4j2uschema.constants;
...
public class Constants
{
	...
	public static final String LABELS_JOINER = "_AND_";    // If changed Here, Change other project Constants: es.um.uschema.s13e.neo4j.queries

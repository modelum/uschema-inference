package es.um.uschema.hbase2uschema.validation.main;
...
import es.um.uschema.hbase2uschema.validation.validation.queries.HBaseValidator;

public class HBase2USchemaValidationMain {

...
import es.um.unosql.doc2unosql.validation.queries.MongoDBValidator;
import es.um.unosql.uNoSQLSchema.UNoSQLSchemaPackage;

public class Doc2uNosqlValidationMain {
	...
	private static void performValidation(uNoSQLSchema uNoSQLSchema) throws IOException {
		MongoDBValidator mongoDBValidator = new MongoDBValidator(DATABASE_HOST, DATABASE_PORT, uNoSQLSchema.getName());

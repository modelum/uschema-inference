...
import es.um.unosql.neo4j2unosql.Neo4j2uNoSQL;
...
public class Neo4j2uSchemaMain
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		Neo4j2uNoSQL neo4j2uNoSQL = new Neo4j2uNoSQL(SAMPLING_RATIO, DATABASE_BOLT, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME);
		neo4j2uNoSQL.process();
		if (WRITE_INTERMEDIATE_JSON) 
			neo4j2uNoSQL.saveJsonToFile(OUTPUTS_FOLDER + DATABASE_NAME + JSON_EXTENSION);
		neo4j2uNoSQL.toXMI(OUTPUTS_FOLDER + DATABASE_NAME + XMI_EXTENSION);

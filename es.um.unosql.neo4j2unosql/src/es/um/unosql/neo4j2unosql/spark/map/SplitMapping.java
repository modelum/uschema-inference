package es.um.unosql.neo4j2unosql.spark.map;

import static es.um.unosql.neo4j2unosql.constants.Constants.REFERENCES;
import static es.um.unosql.neo4j2unosql.constants.Constants.OPENING_BRACKET;
import static es.um.unosql.neo4j2unosql.constants.Constants.CLOSING_BRACKET;
...
import static es.um.unosql.neo4j2unosql.constants.Constants.DOUBLE_QUOTE_ESCAPED;
import static es.um.unosql.neo4j2unosql.constants.Constants.COMMA;

package es.um.uschema.hbase2uschema.main;
...
import es.um.uschema.hbase2uschema.HBase2USchema;

public class HBase2USchemaMain {
	...
	public static void main(String args[]) throws MasterNotRunningException, ZooKeeperConnectionException, IOException {
		...
		HBase2USchema hbase2uschema = new HBase2USchema();
		USchema schema = hbase2uschema.hbase2uschema(DATABASE_URL, DATABASE_PORT, DATABASE_NAME);
		hbase2uschema.toXMI(schema, OUTPUTS_FOLDER + DATABASE_NAME + XMI_EXTENSION);

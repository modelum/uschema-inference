package es.um.uschema.doc2uschema.validation.queries.constants;
...
public class Constants
{
	...
	public static final String NUMBER_FIRST_UPPERCASE = "Number";
	public static final String INTEGER = "integer";
	public static final String INTEGER_FIRST_UPPERCASE = "Integer";
	public static final String BOOLEAN_SHORT = "b";
	public static final String JAVA_LANG_PACKAGE = "java.lang.";
	public static final String DOCUMENT_FULL_NAME = "org.bson.Document";

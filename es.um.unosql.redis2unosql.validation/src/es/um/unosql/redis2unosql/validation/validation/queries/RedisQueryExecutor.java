...
import static es.um.unosql.redis2unosql.validation.queries.constants.Constants.ASTERISK;
import static es.um.unosql.redis2unosql.validation.queries.constants.Constants.COLON;
import static es.um.unosql.redis2unosql.validation.queries.constants.Constants.DOT;
import static es.um.unosql.redis2unosql.validation.queries.constants.Constants.LEFT_SQUARE_BRACKET;
import static es.um.unosql.redis2unosql.validation.queries.constants.Constants.RIGHT_SQUARE_BRACKET;
...
import es.um.unosql.redis2unosql.validation.queries.utils.TypeUtils;

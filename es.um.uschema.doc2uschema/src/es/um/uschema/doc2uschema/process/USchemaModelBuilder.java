...
import es.um.uschema.doc2uschema.process.util.ReferenceMatcher;
...
public class USchemaModelBuilder
{
	...
	private USchema finalSchema;

	public USchemaModelBuilder()
	{
		_init();
	}

	public USchemaModelBuilder(ReferenceMatcherCreator<EntityType> rmCreator, StructuralVariationSorter varSorter, OptionalTagger optTagger, FeatureAnalyzer analyzer)
	{
		_init();
	...
	public USchema build(USchemaFactory factory, String name, Map<String, List<SchemaComponent>> rawEntities)
	{
		this.factory = factory;

		finalSchema = factory.createUSchema();

...
import es.um.uschema.documents.injectors.pojo.publications.Publication;
...
public class Publications2Db extends Source2Db
{
  ...
  private void storeCSVContent(File csvRoute, String dbName)
  {
    ...
    try
    {
      mappingIterator = csvMapper.readerFor(Publication.class).with(CsvSchema.emptySchema().withHeader()).readValues(csvRoute);

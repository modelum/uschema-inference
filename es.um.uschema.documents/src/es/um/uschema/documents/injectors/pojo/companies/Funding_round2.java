package es.um.uschema.documents.injectors.pojo.companies;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;

@JsonPropertyOrder({"id", "round_code", "source_url", "source_description", "raised_amount", "raised_currency_code", "funded_year", "funded_month", "funded_day", "company"})
public class Funding_round2
{
  private Integer id;
  ...
  public void setInvestments(NamePermalink company) {

...
import es.um.uschema.redis2uschema.spark.map.IdKeyMapping;
import es.um.uschema.redis2uschema.spark.map.JSONMapping;
import scala.Tuple2;
...
public class SparkProcess implements ISparkProcess
{
    ...
    private static final String APP_NAME = "redis2uschema";

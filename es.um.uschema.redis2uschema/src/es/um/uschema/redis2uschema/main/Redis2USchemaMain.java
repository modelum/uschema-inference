package es.um.uschema.redis2uschema.main;
...
import es.um.uschema.redis2uschema.Redis2USchema;
import es.um.uschema.redis2uschema.spark.ISparkProcess;
import es.um.uschema.redis2uschema.spark.SparkProcess;

public class Redis2USchemaMain
{
...
//		});
        ...
        Redis2USchema process = new Redis2USchema(sparkProcess);

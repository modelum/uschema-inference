...
import static es.um.unosql.neo4j.queries.constants.Constants.NODE_ID;
import static es.um.unosql.neo4j.queries.constants.Constants.NODE_LABELS;
import static es.um.unosql.neo4j.queries.constants.Constants.NODE_PROPERTIES;
import static es.um.unosql.neo4j.queries.constants.Constants.NODE_REL_IDS;
import static es.um.unosql.neo4j.queries.constants.Constants.NODE_REL_PROPERTIES;
import static es.um.unosql.neo4j.queries.constants.Constants.NODE_REL_TARGET_NODE_ID;
...
import static es.um.unosql.neo4j.queries.constants.Constants.REL_ID;
import static es.um.unosql.neo4j.queries.constants.Constants.REL_ORIGIN_LABELS;
import static es.um.unosql.neo4j.queries.constants.Constants.REL_ORIGIN_NODE_ID;
import static es.um.unosql.neo4j.queries.constants.Constants.REL_PROPERTIES;
import static es.um.unosql.neo4j.queries.constants.Constants.REL_TARGET_LABELS;
import static es.um.unosql.neo4j.queries.constants.Constants.REL_TARGET_NODE_ID;
...
import es.um.unosql.neo4j.queries.builder.Neo4jQueryBuilder;
...
import es.um.unosql.neo4j.queries.processors.PropertiesRowReductor;
import es.um.unosql.neo4j.queries.spark.SparkConnector;
import es.um.unosql.neo4j.queries.statistics.StatisticsMeter;
import es.um.unosql.neo4j.queries.utils.StringNameUtils;
import es.um.unosql.neo4j.queries.validation.exceptions.DuplicatedIdOnDifferentQueriesException;
...
public class QueriesNeo4j
{
	...
	public void countAll(uNoSQLSchema uNoSQLSchema)
	{
		uNoSQLSchema.getEntities().forEach(et -> {
		...
		uNoSQLSchema.getRelationships().forEach(rt -> {
			if (validation) ids = new HashSet<Long>();
